            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="{{route('kategoriBisnis.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                        ...
                        <tbody>
                            @foreach($data as $item)
                              <tr style="text-align: center">
                                <td><a href="{{route('kategoriBisnis.edit', $item->id)}}" title="">{{$item->nama_kategori}}</a></td>
                                <td>{{$item->keterangan}}</td>
                                <td>
                                  <form action="{{route('kategoriBisnis.destroy',$item->id)}}" method="POST">
                                    @csrf
                                    @method('post')
